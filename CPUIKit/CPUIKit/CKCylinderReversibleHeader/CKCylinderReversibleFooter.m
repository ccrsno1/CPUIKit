...
+ (instancetype)footerWithRefreshingBlock:(MJRefreshComponentRefreshingBlock)refreshingBlock{
    CKCylinderReversibleFooter * header = [[self alloc] initWithPad:44.0f frame:CGRectZero];
...
- (void)prepare
{
    ...
    self.stateLabel.textColor = [UIColor colorWithRGB:0xcccccc];
    ...
    self.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 54 + self.topPad);
    ...
    shapeLayer.strokeColor = [UIColor colorWithRGB:0xFBCD04].CGColor;
    ...
    [self setTitle:@"/  暂 时 没 有 了 /" forState:MJRefreshStateNoMoreData];
}
