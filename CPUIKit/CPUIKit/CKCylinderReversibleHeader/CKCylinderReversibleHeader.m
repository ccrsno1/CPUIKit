...
- (void)prepare
{
    ...
    centerPoint = CGPointMake([UIScreen mainScreen].bounds.size.width / 2, 24 - self.topPad/2);
    CGRect aFrame = CGRectMake(0, self.topPad, self.bounds.size.width, 48 - self.topPad);
