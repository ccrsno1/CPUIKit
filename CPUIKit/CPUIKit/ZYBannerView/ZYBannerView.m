...
- (void)updateSubviewsFrame
{
    ...
    if (!UIEdgeInsetsEqualToEdgeInsets(self.pageControlEdgeInsets, UIEdgeInsetsZero)) {
        CGFloat w = self.frame.size.width - self.pageControlEdgeInsets.left - self.pageControlEdgeInsets.right;
        CGFloat h = ZY_PAGE_CONTROL_HEIGHT;
        CGFloat x = 0 + self.pageControlEdgeInsets.left;
        CGFloat y = self.frame.size.height - h - self.pageControlEdgeInsets.bottom;
