...
typedef NS_ENUM(NSInteger, UIHardwareModel) {
    ...
    UIHardwareModeliPhone7 = 48,
    UIHardwareModeliPhone7Plus = 49,
    
    UIHardwareModeliPhone8 = 50,
    UIHardwareModeliPhone8Plus = 51,
    
    UIHardwareModeliPhoneX = 52,
    UIHardwareModeliPhoneXs = 53,
    UIHardwareModeliPhoneXsMax = 54,
    UIHardwareModeliPhoneXR = 55
