...
-(UIHardwareModel)hardwareModel {
	...
	if(!_hardwareModel) {
        ...
        if ([hwString isEqualToString:@"iPhone9,1"] ||
            [hwString isEqualToString:@"iPhone9,3"]) _hardwareModel = UIHardwareModeliPhone7;
        if ([hwString isEqualToString:@"iPhone9,2"] ||
            [hwString isEqualToString:@"iPhone9,4"]) _hardwareModel = UIHardwareModeliPhone7Plus;
        if ([hwString isEqualToString:@"iPhone10,1"] ||
            [hwString isEqualToString:@"iPhone10,4"]) _hardwareModel = UIHardwareModeliPhone8;
        if ([hwString isEqualToString:@"iPhone10,2"] ||
            [hwString isEqualToString:@"iPhone10,5"]) _hardwareModel = UIHardwareModeliPhone8Plus;
        if ([hwString isEqualToString:@"iPhone10,3"] ||
            [hwString isEqualToString:@"iPhone10,6"]) _hardwareModel = UIHardwareModeliPhoneX;
        if ([hwString isEqualToString:@"iPhone11,8"]) _hardwareModel = UIHardwareModeliPhoneXR;
        if ([hwString isEqualToString:@"iPhone11,2"]) _hardwareModel = UIHardwareModeliPhoneXs;
        if ([hwString isEqualToString:@"iPhone11,4"] ||
            [hwString isEqualToString:@"iPhone11,6"]) _hardwareModel = UIHardwareModeliPhoneXsMax;
	}
...
- (BOOL)isSpecialScreen{
    return [UIScreen mainScreen].bounds.size.height == 896 || [UIScreen mainScreen].bounds.size.height == 812;
